...
pub use core::{
    ...
    ColorSpec, ConnectedComponent, Document, EdgePaletteEntry, ExactAssertion, ExactCheck,
    ...
    ResampleFilter, Sha256Digest, Size, SvgContract, SvgReport, Transform3, VerificationReport,
    VerificationSpec, CHROMA_CANDIDATE_PALETTE, CHROMA_PLAN_METRIC, CHROMA_PLAN_SCHEMA,
    DOCUMENT_SCHEMA, PSD_DEFAULT_ALPHA_THRESHOLD, PSD_DEFAULT_MAX_KNOTS, PSD_EXPORT_SCHEMA,
